...
- 🔭 I’m always working on a unity projects.
...
- Language: C#, HLSL, C++, C, Python, Java, JavaScript, Kotlin, Objective-C, Swift, Visual Basic, SQL
- Framework: Unity, .NET, Razor, Phaser
- BaaS: UGS, Firebase, AWS, Ncloud
- Backend: Docker, Ubuntu, n8n, Supabase
- AI: Ollama, vLLM, RAG, TouchSharp
